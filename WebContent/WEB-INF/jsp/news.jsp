...
<body>
	...
	<div class="center-join2 news_img">
		...
		<div id="space"></div>
		<div id="space"></div>
		<span>최신 금 관련 뉴스를 항상 곁에 두고<br>급변하는 국제 경제정치 속 금 투자의 기회를
			잡으세요.
		</span>
		<div class="center-square-news">
			매일 5천 개 이상의 신문사의 실시간 뉴스 정보를 제공하는 외신매체 <a href="https://newsapi.org/"><b>newsapi</b></a>와
			국내의 거의 모든 신문사의 기사를 제공하는 <a href="http://news.naver.com/"><b>네이버
					뉴스</b></a>의 금 관련 기사만을 필터링하여 핵심 정보만을 전달드립니다.
		</div>
	</div>
	<!-- /navbar -->
	<div class="wrapper">
