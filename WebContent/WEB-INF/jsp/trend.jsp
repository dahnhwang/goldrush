...
<body>
	...
	<div class="center-join2 wordtrend_img">
		...
		<div class="center-square">
			금 가격에 영향을 미치는 요인은 시대와 상황에 따라 매우 다변적이기 때문에 단순한 단어 수 집계로 금가격의 상승 또는
			하락과의 상관성을 밝혀내는 것에는 한계가 있습니다. (회귀트리모형으로 분석 시, 가장 상관도가 높은 단어의 상관계수가
			0.001643밖에 되지 않아 모델링에 적합하지 않음)
			<p></p>
			따라서, 30년간 뉴스에서 추출한 월별 주요 키워드를 금가격 변동추이와 함께 사용자가 직접 살펴보고 금 가격과의 연관관계를
			유추할 수 있도록 마련하였습니다.
		</div>
	</div>
